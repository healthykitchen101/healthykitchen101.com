...
*   Cooking Steaks (40%) - **7.7**/undefined
...
To make sure our **8 oz**, **1.38-inch top blade steak** got the best possible crusting, we first preheated the GreenLife to 400°F. Similar to other medium-sized electric skillets in our data, this took only **2 min 36 sec** which translated to a whopping 9.4/10.

Once the steak was seasoned and a meat thermometer inserted, we seared both sides for precisely **4 min 5 sec**. We then gave 1 min 30 sec to the edge with the fat cap, while the remaining edges received 1 min each.
...
The GreenLife skillet has a **cast aluminum** pan and these are more durable than non-cast pans (+3). We calculated the total capacity to be around 6.1 quarts but the usable volume should be 5 quarts as the label states.

One thing that stood out to us was the skillet’s **rivetless interior** which enables snag-free cooking and cleaning. Although the pan was only 0.08 inches (2 mm) thick—and not 0.16 inches (4 mm) as with some other pans—we noticed no heat deformity and the pan heated evenly (+1).

GreenLife’s non-stick coating is not just free of PFAS (which includes PTFE or Teflon) and PFOAs, but it is also guaranteed free of lead and cadmium (+2). The pan is also dishwasher-safe (+2).

The instruction manual states that this skillet isn’t designed for deep frying. Additionally, it recommends using butter or high smoke point oils and not cooking sprays or low smoke point oils like olive oil.
...
The tempered glass lid is dishwasher-safe (+4). It has a steam vent to release the pressure and a steel handle (+3). In tune with its high build quality, the metal edging is correctly sized to fit the pan well (+3).
...
The GreenLife Ceramic Non-Stick Electric Skillet CC003725-002 doesn’t have ultra-convenient features like a detachable pan or folding base, but it’s easy to use, clean, and store away.
